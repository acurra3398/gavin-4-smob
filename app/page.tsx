      ...
      <main id="top" className="relative z-10 bg-white dark:bg-slate-950 transition-colors">
        ...
        <footer className="bg-slate-900 text-slate-400 py-8 md:py-12">
          <div className="max-w-6xl mx-auto px-4 md:px-6 flex flex-col items-center gap-5 md:gap-6 text-sm">
            ...
            <a
              href="https://github.com/acurra3398/gavin-4-smob"
              target="_blank"
              rel="noopener noreferrer"
              className="clickable inline-flex items-center gap-2 px-4 py-2 rounded-full border border-slate-700 bg-slate-800/60 text-slate-300 text-xs font-medium hover:border-amber-400 hover:text-amber-300 transition-colors"
            >
              <svg
                className="w-4 h-4"
                fill="currentColor"
              ...
              <span>Just like Gavin&apos;s campaign, we&apos;re transparent</span>
            </a>
          </div>
        </footer>
      </main>
